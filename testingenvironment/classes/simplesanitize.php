 ...
 * - Send any questions or comments to simplesanitize@sterlingdezine.com
 *
 * You may use this code for personal or commercial use.
 * You may not distribute this code for free or for sale.
 * You may not distribute this code to others for their own use. Only
 * projects/applications where you are the main leader/coordinator can use
 * this code.
 * "You" is defined as the individual or organization that purchases the
 * license to use this code
 * This code is not meant to be the only security means for your web applications.
 * Any security breaches, attacks, etc found to be successful is not the responsibilty
 * of this code or its creator.
 * Using this code comes with no warranty. Use at your own risk.
 *
 * Send me your comments, questions, or suggestions to:
 *		simplesanitize@sterlingdezine.com
 *		http://sterlingdezine.com/simplesanitize
 *		http://themeforest.net/user/sterlingdezine
 *
 * @author Sterling Williams - sterlingdezine.com - simplesanitize@sterlingdezine.com
