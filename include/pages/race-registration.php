...
if($event !== null) {
	...
	if(!$event->registrationAllowed())
		echo 'Online registration through Run That Race is closed';
		...
		<form action="/include/requests/registerProcess.php" method="post" id="register-form">
			...
			<a id="registrant-payment" class="button float-r" style="vertical-align: bottom">Next</a>
			<input type="submit" name="register_submit" class="float-r" style="margin-right: 2em; line-height: 1.4" value="Add Another Participant" />
		</form>
