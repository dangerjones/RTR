 ...
 */
define('TESTING', $_SERVER['SERVER_ADDR'] == '10.196.190.67' ? true : false);

/*
 * Database constants
 */
define('MYSQL_USER', 'n62run5_website');
define('MYSQL_PASS', 'RnPh);28@:CU');
define('MYSQL_DB', 'n62run5_website');
